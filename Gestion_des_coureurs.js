...
// ─── 2) Protection de /Gestion_des_coureurs.html ────────────────────────────────────────────────
//    On intercepte toute requête GET vers /Gestion_des_coureurs.html avant de servir le fichier statique.
app.get('/Gestion_des_coureurs.html', (req, res, next) => {
...
// ─── 3) Servir les fichiers statiques (login.html, Gestions_des_coureurs.html, JS, CSS, etc.) ────
app.use(express.static('/home/projet-chrono/chronoTrail-preinscrip/public/'));
